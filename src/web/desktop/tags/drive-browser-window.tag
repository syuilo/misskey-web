mk-drive-browser-window
	mk-window(controller={ window-controller }, is-modal={ false }, is-child={ opts.is-child }, width={ '800px' }, height={ '500px' })
		<yield to="header">
		i.fa.fa-cloud
		| ドライブ
		</yield>
		...
		mk-drive-browser(controller={ parent.browser-controller }, xmultiple={ true }, is-in-window={ true }, folder={ parent.folder })
		</yield>
